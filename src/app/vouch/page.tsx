      ...
      <main className="ml-60 pt-14 px-8 py-8">
        ...
        {!canVouch && (
          <div
            ...
            style={{
              marginBottom: 24,
              borderColor: 'rgba(204,119,0,0.4)',
              background: 'rgba(204,119,0,0.06)',
              color: '#cc7700',
              fontSize: 14,
            }}
          >
        ...
        <div
          style={{
            ...
            borderRadius: 10, background: 'rgba(255,45,74,0.07)',
            border: '1px solid rgba(255,45,74,0.25)', marginBottom: 24,
            fontSize: 13, color: '#ff2d4a',
          }}
        >
          <Icon name="warning" size={18} style={{ color: '#ff2d4a', flexShrink: 0 }} />
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(12, 1fr)', gap: 20 }}>
          ...
          <div className="bento" style={{ gridColumn: 'span 5' }}>
            ...
            <p style={{ fontSize: 13, color: '#6a6a70', marginBottom: 20 }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: 16 }}>
              <div style={{ fontSize: 20, fontFamily: 'monospace', fontWeight: 700, color: '#a00020' }}>
                {session.node_id}
              </div>
              <div style={{ fontSize: 13, color: '#6a6a70', marginTop: 4 }}>{session.display_name}</div>
            </div>

            <button onClick={copyNodeId} className="btn-ghost" style={{ width: '100%', justifyContent: 'center', color: copied ? '#00b860' : undefined }}>
            ...
            <div className="bento">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12, alignItems: 'end' }}>
                ...
                <button
                  ...
                  style={{
                    height: 52, borderRadius: 10, border: '1px solid #28282c',
                    background: scanState === 'scanning' ? 'rgba(255,45,74,0.1)' : '#070708',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    gap: 8, cursor: 'pointer', fontSize: 13, fontWeight: 600,
                    color: scanState === 'scanning' ? '#ff2d4a' : '#d2d2d6',
                  }}
                >
                ...
                <div>
                  <label style={{ fontSize: 12, color: '#6a6a70', display: 'block', marginBottom: 6 }}>
                    Or enter Node ID
                  </label>
                  <input
              ...
              {errorMsg && (
                <div style={{ marginTop: 12, fontSize: 13, color: '#ff2d4a' }}>{errorMsg}</div>
              )}
            </div>
            ...
            {vouchState === 'circular' ? (
              ...
              <div
                ...
                style={{
                  ...
                  border: '1px solid rgba(0,184,96,0.35)',
                  background: 'rgba(0,184,96,0.05)',
                }}
              >
                <Icon name="check_circle" size={48} style={{ color: '#00b860', marginBottom: 12 }} />
                <div style={{ fontSize: 20, fontWeight: 700, marginBottom: 8 }}>Vouch confirmed</div>
                <div style={{ fontSize: 14, color: '#6a6a70' }}>
                  {foundUser?.display_name} has been vouched.
                  {voucheeNewScore !== null && (
                    <> Their score is now <strong style={{ color: '#00b860' }}>{voucheeNewScore}</strong>.</>
                  )}
                </div>
                <button onClick={handleReject} className="btn-ghost" style={{ marginTop: 20 }}>
                  Vouch someone else
              ...
              <div className="bento">
                <div
                  style={{
                    ...
                    marginBottom: 20, paddingBottom: 20, borderBottom: '1px solid #28282c',
                  }}
                >
                  <div
                    style={{
                      ...
                      border: '2px solid rgba(160,0,32,0.35)',
                      display: 'flex', alignItems: 'center', justifyContent: 'center',
                      fontSize: 16, fontWeight: 700, color: '#a00020', flexShrink: 0,
                    }}
                  >
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 13, color: '#6a6a70', marginTop: 2 }}>
                      {foundUser.skill ?? 'Other'}{foundUser.borough ? ` · ${foundUser.borough}` : ''}
                    </div>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <TierBadge tier={foundUser.tier} />
                    <div style={{ fontSize: 13, color: '#6a6a70', marginTop: 6 }}>
                ...
                >
                  <span style={{ flex: 1, fontSize: 14, color: '#d2d2d6' }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: 'rgba(0,184,96,0.15)',
                      border: '1px solid rgba(0,184,96,0.4)',
                      color: '#00b860', fontSize: 14, fontWeight: 600, cursor: 'pointer',
              ...
              <div
                ...
                style={{
                  ...
                  color: '#28282c', minHeight: 160,
                }}
              >
                <Icon name="person_search" size={40} style={{ color: '#28282c' }} />
        ...
        <div style={{ marginTop: 20, display: 'flex', alignItems: 'center', gap: 10 }}>
          <div
            style={{
              ...
              background: 'rgba(160,0,32,0.15)', border: '1px solid rgba(160,0,32,0.35)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 11, fontWeight: 700, color: '#a00020',
            }}
          >
            {initials}
          </div>
          <span style={{ fontSize: 13, color: '#6a6a70' }}>
