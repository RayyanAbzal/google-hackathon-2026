...
const ALL_RESULTS: Result[] = [
  ...
  { refCode: 'SE1·001', icon: 'stethoscope', iconColor: '#40e56c', title: 'Verified Doctor', sub: 'General · Adult', dist: '0.4 km · SE1', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: "At Guy's · 12 min wait", featured: true, category: 'Medical', subCategory: 'MEDICAL · DOCTORS', borough: 'Southwark', prof: 'Doctor', detail: 'General practitioner with 8 years experience. Specialises in post-disaster triage and adult primary care.', contact: "Report to Guy's Aid Hub reception desk. Bring your CivicTrust ID." },
  ...
  { refCode: 'SE1·011', icon: 'health_and_safety', iconColor: '#40e56c', title: 'Verified Nurse', sub: 'A&E · Triage', dist: '0.4 km · SE1', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: "Co-located at Guy's", category: 'Medical', subCategory: 'MEDICAL · NURSING & PHARMACY', borough: 'Southwark', prof: 'Nurse', detail: "A&E triage nurse with critical care certification. Co-located with Guy's Aid Hub.", contact: "Guy's Aid Hub triage entrance." },
  ...
  // Legal - Southwark
  { refCode: 'SE1·101', icon: 'balance', iconColor: '#40e56c', title: 'Verified Lawyer', sub: 'Housing · Tenancy', dist: '0.8 km · SE1', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: 'Pro bono · emergency', category: 'Legal', subCategory: 'LEGAL · HOUSING & WELFARE', borough: 'Southwark', prof: 'Lawyer', detail: 'Housing solicitor offering pro bono emergency advice for displaced residents.', contact: "Guy's Aid Hub, legal desk." },
  ...
  { refCode: 'SW9·011', icon: 'health_and_safety', iconColor: '#40e56c', title: 'Verified Nurse', sub: 'Paediatric · ICU', dist: '0.6 km · SW9', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: 'Brixton Hub · on-site', category: 'Medical', subCategory: 'MEDICAL · NURSING & PHARMACY', borough: 'Lambeth', prof: 'Nurse', detail: 'Paediatric ICU nurse at Brixton Aid Hub.', contact: 'Brixton Aid Hub, paediatrics wing.' },
  { refCode: 'SW9·101', icon: 'balance', iconColor: '#40e56c', title: 'Verified Lawyer', sub: 'Immigration · Asylum', dist: '0.5 km · SW9', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: 'Pro bono · urgent cases', category: 'Legal', subCategory: 'LEGAL · HOUSING & WELFARE', borough: 'Lambeth', prof: 'Lawyer', detail: 'Immigration lawyer supporting asylum seekers.', contact: 'Brixton Aid Hub, immigration desk.' },
  { refCode: 'SW9·201', icon: 'engineering', iconColor: '#40e56c', title: 'Civil Engineer', sub: 'Roads · Infrastructure', dist: '0.7 km · SW9', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: 'Road clearance ops', category: 'Engineering', subCategory: 'ENGINEERING · STRUCTURAL & UTILITIES', borough: 'Lambeth', prof: 'Engineer', detail: 'Civil engineer coordinating road clearance and infrastructure repair.', contact: 'Lambeth Aid Hub operations desk.' },
  // Hackney
  { refCode: 'E8·001', icon: 'stethoscope', iconColor: '#40e56c', title: 'Verified Doctor', sub: 'General · Adult', dist: '0.5 km · E8', avail: 'Available now', availColor: '#40e56c', tier: 'T3', tierColor: '#40e56c', note: 'Hackney Hub · 20 min wait', category: 'Medical', subCategory: 'MEDICAL · DOCTORS', borough: 'Hackney', prof: 'Doctor', detail: 'General practitioner at Hackney Aid Hub.', contact: 'Hackney Aid Hub, Mare Street.' },
  { refCode: 'E8·011', icon: 'health_and_safety', iconColor: '#40e56c', title: 'Verified Nurse', sub: 'Mental Health', dist: '0.8 km · E8', avail: 'Available now', availColor: '#40e56c', tier: 'T2', tierColor: '#b0c6ff', note: 'Mental health triage', category: 'Medical', subCategory: 'MEDICAL · NURSING & PHARMACY', borough: 'Hackney', prof: 'Nurse', detail: 'Mental health nurse providing crisis support.', contact: 'Hackney Aid Hub, welfare wing.' },
  { refCode: 'E8·201', icon: 'plumbing', iconColor: '#40e56c', title: 'Water Engineer', sub: 'Pipes · Sanitation', dist: '0.6 km · E8', avail: 'Available now', availColor: '#40e56c', tier: 'T2', tierColor: '#b0c6ff', note: 'Water safety assessments', category: 'Engineering', subCategory: 'ENGINEERING · STRUCTURAL & UTILITIES', borough: 'Hackney', prof: 'Engineer', detail: 'Water systems engineer assessing pipe integrity.', contact: 'Hackney Aid Hub, utilities team.' },
]

const HEAT_POINTS = [
  { x: 330, y: 320, r: 130, color: '#40e56c', intensity: 0.65 },
  { x: 260, y: 360, r: 100, color: '#40e56c', intensity: 0.50 },
  { x: 290, y: 250, r:  90, color: '#40e56c', intensity: 0.45 },
...
const HUB_PINS = [
  { x: 330, y: 320, label: "A · Guy's", color: '#40e56c' },
  { x: 260, y: 360, label: 'B · Borough', color: '#40e56c' },
  ...
  return (
    <div
      ...
      style={{
        ...
        background: featured ? 'rgba(64,229,108,0.04)' : 'transparent',
        position: 'relative',
        cursor: 'pointer',
        transition: 'background 0.1s',
      }}
    >
      {featured && <div style={{ position: 'absolute', left: 0, top: 0, bottom: 0, width: 2, background: '#40e56c' }} />}
      ...
      <div>
        <div style={{ fontSize: 13, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 6 }}>
          {title}
          {featured && (
            <span className="mono" style={{ fontSize: 9, padding: '2px 5px', background: '#40e56c', color: '#002d6f', borderRadius: 3, letterSpacing: '0.08em', fontWeight: 700 }}>FEATURED</span>
          )}
        </div>
...
export default function FindPage() {
  ...
  const filtered = ALL_RESULTS.filter(r => {
    ...
    const statusMatch = activeStatus === 'Available now' ? r.availColor === '#40e56c' : true
    if (search.trim()) {
              ...
              <div style={{ display: 'flex', gap: 4 }}>
                {STATUSES.map(s => (
                  <button
                    ...
                    style={{
                      padding: '4px 10px', borderRadius: 999, fontSize: 12, cursor: 'pointer', border: 'none',
                      background: s === activeStatus ? 'rgba(64,229,108,0.12)' : 'rgba(66,70,85,0.3)',
                      color: s === activeStatus ? '#40e56c' : '#8c90a1',
                      outline: s === activeStatus ? '1px solid rgba(64,229,108,0.4)' : '1px solid transparent',
                    }}
                  >{s}</button>
                ))}
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 20, alignItems: 'flex-start' }}>
            ...
            <div style={{ position: 'sticky', top: 80, display: 'flex', flexDirection: 'column', gap: 10 }}>
              <div style={{ position: 'relative', height: 480, border: '1px solid rgba(66,70,85,0.5)', borderRadius: 10, overflow: 'hidden', background: '#0a0e14' }}>
                ...
                <LondonBoroughs width={580} height={480} highlights={[activeBorough]} />
                ...
                <div style={{ position: 'absolute', bottom: 12, left: 12, right: 12, padding: '8px 12px', background: 'rgba(16,20,26,0.92)', border: '1px solid rgba(66,70,85,0.5)', borderRadius: 6, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <div style={{ height: 8, width: 120, borderRadius: 999, background: 'linear-gradient(90deg, #424655, #b0c6ff, #fbbf24, #40e56c)' }} />
            ...
            <div style={{ display: 'flex', flexDirection: 'column', maxHeight: 'calc(100vh - 240px)', overflowY: 'auto', paddingRight: 2 }}>
              ...
              {/* Featured aid hub */}
              <div style={{ border: '2px solid #40e56c', borderRadius: 8, padding: 16, background: 'rgba(64,229,108,0.04)', marginBottom: 16, position: 'relative', flexShrink: 0 }}>
                <div style={{ position: 'absolute', top: -10, left: 14, padding: '2px 8px', background: '#40e56c', color: '#002d6f', fontFamily: 'JetBrains Mono, monospace', fontSize: 9, fontWeight: 700, letterSpacing: '0.1em', borderRadius: 3 }}>
                  AID HUB · NEAREST
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginTop: 4 }}>
                  <div style={{ width: 48, height: 48, borderRadius: 8, background: 'rgba(64,229,108,0.1)', border: '1px solid #40e56c', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <span className="material-symbols-outlined" style={{ fontSize: 24, color: '#40e56c' }}>local_hospital</span>
                  </div>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: 10, marginTop: 4, fontSize: 12, color: '#c2c6d8' }}>
                      ...
                      <span style={{ color: '#40e56c', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
                        <span style={{ width: 5, height: 5, borderRadius: '50%', background: '#40e56c', display: 'inline-block' }} />
                        4 doctors · 2 nurses · 1 pharmacist on-site
                      </span>
                    </div>
                  </div>
                  <button style={{ padding: '8px 14px', background: '#40e56c', color: '#002d6f', border: 'none', borderRadius: 6, fontSize: 12, fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap', flexShrink: 0 }}>
                    Walk to hub →
                  </button>
                </div>
              </div>
